...
$lang['Add a comic to this storyline'] = 'Add a comic post to this storyline';
...
$lang['Comic scheduling options'] = 'Comic scheduling options';
$lang['Default schedule date'] = 'Default schedule date';
$lang['Today'] = 'Today';
$lang['After last scheduled post'] = 'After last scheduled post';
$lang['Default schedule time'] = 'Default schedule time';
$lang['Right now'] = 'Right now';
$lang['Midnight'] = 'Midnight';
$lang['Morning'] = 'Morning';
$lang['Noon'] = 'Noon';
$lang['Evening'] = 'Evening';
$lang['Post Interval'] = 'Post Interval';
$lang['Right after the latest post'] = 'Immediately';
$lang['one day after the latest post'] = 'Every day';
$lang['the next weekday after the latest post'] = 'Every weekday';
$lang['two weekdays after the latest post'] = 'Monday, Wednesday, Friday';
$lang['one week after the latest post'] = 'Once a week';
$lang['one month after the latest post'] = 'Once a month';
...
$lang['tooltip-storylinecaption'] = "You may optionally provide a short description or subtitle for your storyline.";
...
$lang['tooltip-scheduledate'] = 'This option determines what the date will be when you add a new comic post. You can either choose to default to today or a date in the future that will be automatically calculated based on your chosen posting schedule. This makes it easy to schedule if you have a long comic buffer. Note that if your last comic post is in the past the date for a new comic might also be in the past depending on your post interval.';
$lang['tooltip-scheduletime'] = 'This option determines the default time will be when you add a new comic. This is useful if you want your comics to always publish at the same time of day. Note these times are based on the server time zone set in the site options.';
$lang['tooltip-postinterval'] = 'Use this option to let ComicControl help schedule your comics. When you add a new comic page the date will automatically be set according to the schedule you choose. You can always adjust the date as you see fit but every new post will line up with your schedule.';
...
$lang['tooltip-siteauthor'] = 'This is the author name that will be used for RSS feeds and can be included in your pages.';
