...
$user_lang['This page does not have an RSS feed.']= 'This page does not have an RSS feed.';
...
$user_lang['Tags: '] = "Tags: ";
$user_lang['Comics tagged with "%s"'] = 'Comics with tag "%s"';
$user_lang['Posts tagged with "%s"'] = 'Posts tagged with "%s"';
$user_lang['No results found.'] = "No results found."; 
$user_lang['Please try a different search.'] = "No comics with that tag exist.";
